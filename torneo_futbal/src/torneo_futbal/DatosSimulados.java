...
public class DatosSimulados {
	 ...
	 public static void inicializar() {
	     ...
	     // ====== Partido de prueba ======
	   	 ...
	   	 Equipo local = club1.getEquipos().get(0); // Tigres Rojos
	   	 Equipo visitante = club1.getEquipos().get(1); // Lobos Azules
	   	 Estadio estadioLocal = club1.getEstadios().get(0); // Estadio Central

	   	 Partido partidoDePrueba = new Partido(local, visitante);
